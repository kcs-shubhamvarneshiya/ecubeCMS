$(document).ready(function () {
    ...
    $('#btnSubmit').click(function () {
        if ($('#RoleName').val().trim() == '') {
            jAlert(kcs_Message.InputRequired('Role Name'), 'RoleName');
            return false;
        }
...
function LoadPermission() {
    jQuery('#tblRolePermission').jqGrid({
        ...
        postData: { lgRoleId: jQuery('#Id').val() },
        datatype: 'json',
        mtype: 'GET',
        colNames: [
        ...
        colModel: [
            ...
            { name: 'View_Right', index: 'View_Right', align: 'left', width: 40, sortable: false, formatter: ViewFormat },
            { name: 'Add_Right', index: 'Add_Right', align: 'left', width: 40, sortable: false, formatter: AddFormat },
            { name: 'Edit_Right', index: 'Edit_Right', align: 'left', width: 40, sortable: false, formatter: EditFormat },
            { name: 'Delete_Right', index: 'Delete_Right', align: 'left', width: 40, sortable: false, formatter: DeleteFormat },
            { name: 'Export_Right', index: 'Export_Right', align: 'left', width: 40, sortable: false, formatter: ExportFormat, hidden: true }
        ],
        viewrecords: true,
