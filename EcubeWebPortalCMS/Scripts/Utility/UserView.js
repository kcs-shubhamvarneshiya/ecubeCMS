...
function LoadUserGrid() {
    ...
    jQuery('#tblUser').jqGrid({
        ...
        mtype: 'GET',
        colNames: [
            'First Name', 'Last Name', 'Mobile No', 'Email Id', 'Username', 'Address', 'Role Name', 'Is Active', 'Edit', 'Delete'],
        colModel: [
            { name: 'FirstName', index: 'FirstName', align: 'left' },
            { name: 'SurName', index: 'SurName', align: 'left' },
