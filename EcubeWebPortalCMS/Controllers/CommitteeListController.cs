...
// ***********************************************************************
// <copyright file="CommitteeListController.cs" company="KCS">
//     Copyright ©  2016
// </copyright>
// <summary>CommitteeListController</summary>
// ***********************************************************************
...
namespace EcubeWebPortalCMS.Controllers
{
    ...
    /// <summary>
    /// Class CommitteeListController.
    /// </summary>
    public class CommitteeListController : Controller
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommitteeListController" /> class.
        /// </summary>
        /// <param name="iCustomPageCommand">The i custom page command.</param>
        public CommitteeListController(ICustomPageCommand iCustomPageCommand)
        {
        ...
        public ActionResult CommitteeList()
        {
            ...
            try
            {
                string pageName = "CommitteeList";
                int pageId = 0;
                UserCommand userCommand = new UserCommand();
                GetPageRightsByUserIdResult getPageRights = userCommand.GetPageRights(MySession.Current.UserId, pageName);
        ...
        /// <returns>Action Result.</returns>
        [HttpPost]
        public ActionResult CommitteeList(CustomPageModel objVendor)
        {
            var logger = new LoggerConfiguration().WriteTo.MSSqlServer(conn.ConnectionString.ToString(), "Logs").CreateLogger();
            string information = AppConstants.ProjectName + "/" + this.GetType().Name + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name.ToString();
            ...
            try
            {
                GetPagePermissionResult objPermission = Functions.CheckPagePermission(PageMaster.CommitteeList);
                ...
                string strErrorMsg = this.ValidateCommitteeList(objVendor);
                ...
                else
                {
                    if (objVendor.Id > 0)
                    {
                        this.ViewData["Message"] = Functions.AlertMessage("Committee List", MessageType.Success);
                    }
                    ...
                    {
                        this.ViewData["Success"] = "0";
                        this.ViewData["Message"] = Functions.AlertMessage("Committee List", MessageType.Fail);
                    }
                }
        ...
        private string ValidateCommitteeList(CustomPageModel objVendor)
        {
            var logger = new LoggerConfiguration().WriteTo.MSSqlServer(conn.ConnectionString.ToString(), "Logs").CreateLogger();
            string information = AppConstants.ProjectName + "/" + this.GetType().Name + "/" + System.Reflection.MethodBase.GetCurrentMethod().Name.ToString();
